            ...
            <article class="person-data" id="person-data">
                ...
                <form action="UpdateUserServlet" method="post">
                    <div class="p-client-box">
                        ...
                        <input id="p-client-name" type="text" value="${sessionScope.user.firstName}" name="name" disabled="true" />
                    </div>

                    <div class="p-client-box">
                        <label for="p-client-surname">Nazwisko:</label>
                        <input id="p-client-surname" type="text" value="${sessionScope.user.lastName}" name="lastName" disabled />
                    </div>

                    <div class="p-client-box">
                        <label for="p-client-dateofB">Data urodzenia:</label>
                        <input id="p-client-dateofB" type="date" value="1987-12-23" name="dateOfBirth" disabled />
                    </div>

                    <div class="p-client-box">
                        <label for="p-client-Email">Email:</label>
                        <input id="p-client-Email" type="text" value="${sessionScope.user.mail}" name="email" disabled />
                    </div>
